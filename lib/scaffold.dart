...
class ZoomScaffoldState extends State<ZoomScaffold> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    menuController = new MenuController(vsync: this,)..addListener(() => setState(() {}));
  }
    ...
    return zoomAndSlideContent(new Container(
        ...
        child: new Scaffold(
          ...
          appBar: new AppBar(
            ...
            title: new Text(widget.contentScreen.title,
  ...
  switch (menuController.state) {
   ...
   return new Transform(
     transform: new Matrix4
       .translationValues(slideAmount, 0.0, 0.0)..scale(contentScale, contentScale),
...
class ZoomScaffoldMenuControllerState extends State<ZoomScaffoldMenuController> {
   ...
   void initState() {
      ...
      menuController.addListener(onMenuControllerChange);
   }

   @override
   void dispose() {
     menuController.removeListener(onMenuControllerChange);
       super.dispose();
   }
